...
import {Router, ActivatedRoute, Params, ɵafterNextNavigation} from '@angular/router';
...
export class LoginComponent implements OnInit {
  ...
  constructor(
    ...
    this.page_title = 'Autentificación de Usuario';
  ...
  onSubmit(form: any){
      this._userService.signup(this.user, null).subscribe({
        next: response => {
          console.log('En el metodo signup ',response.status);
